...
const {verifyExistingId, verifyNewObject, verifyModifiedObject, verifyUserId} = require("./middleware");
...
router.post("/", verifyNewObject, verifyUserId, async (req, res, next) => {
    try{
