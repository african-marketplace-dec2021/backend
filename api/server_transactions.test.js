...
describe("[1] describe endpoint /api/transactions", ()=>{
    ...
    describe("[1-1] describe endpoint GET /api/transactions", ()=>{
    ...
    describe("[1-2] describe endpoint GET /api/transactions/:id", ()=>{
    ...
    describe("[1-3] describe endpoint POST /api/transactions/", ()=>{
    ...
    describe("[1-4] describe endpoint PUT /api/transactions/:id", ()=>{
    ...
    describe("[1-5] describe endpoint DELETE /api/transactions/:id", ()=>{
